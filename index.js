...
const search = {name:"search", text: "Поиск"}
const setting = {name:"setting",text:"Настройки"}
const profile = {name:"profile", text:`Профиль`}


    bot.on ('message',(msg) => {const userId = msg.chat.id;
